    ...
    <main class="max-w-6xl mx-auto px-6 py-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <a href="/daftar" class="group">
                <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow duration-300">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900 group-hover:text-blue-600 transition-colors duration-300">Pendaftaran</h3>
                </div>
            </a>
            ...
            <div class="group">
                <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow duration-300">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900 group-hover:text-green-600 transition-colors duration-300">Cek Antrian</h3>
                </div>
            </div>
            ...
            <div class="group">
                <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow duration-300">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900 group-hover:text-purple-600 transition-colors duration-300">Jadwal Konsul</h3>
                </div>
            </div>
            ...
            <div class="group">
                <div class="flex flex-col items-center p-6 bg-white rounded-lg shadow hover:shadow-md transition-shadow duration-300">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900 group-hover:text-yellow-600 transition-colors duration-300">Pembayaran</h3>
                </div>
            </div>
        </div>
    </main>

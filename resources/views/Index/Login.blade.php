...
<body>
     <img src="{{ url('img/LOGO.png') }}" height="240" class="static -mt-24 md:mt-44 lg:-mt-44 scale-75 left-5 bg-transparent rounded-4xl">
  ...
  <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
    <h2 class="text-2xl font-bold text-gray-900 mb-6 text-center">MEADYS <br class="text-[1rem]">Login</h2>
     ...
     <form method="POST" class="space-y-6" action="{{ route('login_store') }}">
        @csrf
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Surel</label>
        <input
          type="email"
      ...
      <div class="flex items-center justify-between">
        ...
        <a href="{{ route('reset') }}" class="text-sm text-indigo-600 hover:text-indigo-500">Lupa Kata Sandi?</a>
      </div>

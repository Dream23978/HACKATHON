...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 -mt-40 rounded-2xl shadow-xl">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm -mt-27
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="{{ route('Login.store') }}" method="POST">
        @csrf
      <div>
        <label for="username" class="block text-sm/6 font-medium text-gray-900 font-sans">Nama Pengguna</label>
        <div class="mt-2">
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="{{route('reset')}}" class="font-semibold text-indigo-600 hover:text-indigo-500">Lupa Password?</a>
          </div>
        </div>
        <div class="mt-2">

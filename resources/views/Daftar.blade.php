...
<body class="animate-fadeinb">
    ...
    <section class="bg-amber-300-50 flex items-center justify-center min-h-screen  lg:-mt-28">
        ...
        <form method="POST" action="{{ route('daftar.store') }}"
            class="bg-white p-6 rounded-lg shadow-md w-full max-w-md md:block sm:block">
            @csrf
            <div class="mb-4">
                <label for="pilih_provinsi" class="block text-sm font-medium text-gray-700">Pilih Provinsi</label>
                <select name="pilih_provinsi" id="pilih_provinsi"
                    class="mt-1 block w-full bg-amber-50 border-2 border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-amber-200">
            ...
            <div class="mb-4 hidden" id="pilih_rumah_sakit">
                <label for="pilih_rumah_sakit_select" class="block text-sm font-medium text-gray-700">Pilih Rumah
                    Sakit</label>
                <select name="pilih_rumah_sakit" id="pilih_rumah_sakit_select"
                    class="mt-1 block w-full bg-amber-50 border-2 border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-amber-200">
            ...
            <div class="mb-4 hidden" id="pilih_poli">
                ...
                <select name="pilih_poli" id="pilih_poli_select"
                    class="mt-1 block w-full bg-amber-50 border-2 border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-amber-200">
            ...
            <div class=" justify-center hidden" id="button_selesai">
                <button type="submit"
                    class="border-2 m-2 p-2 rounded-2xl bg-blue-600 text-white hover:bg-blue-500 transition duration-200">
                    Selesai
                </button>
            </div>
        </form>
